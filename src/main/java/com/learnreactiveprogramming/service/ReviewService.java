...
public class ReviewService {
    ...
    public Flux<Review> retrieveReviewsFlux_RestClient(Long movieInfoId) {
        ...
        // We will build the url using UrlComponentsBuilder since we are using the queryParam
        var uri = UriComponentsBuilder.fromUriString("/v1/reviews")
                .queryParam("movieInfoId", movieInfoId)  // Note : movieInfoId is passed as a query param
                .buildAndExpand()
                .toUriString();
